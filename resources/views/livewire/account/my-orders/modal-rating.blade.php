        ...
        <div class="modal-content rounded border-0 shadow-sm">
            ...
            <div class="modal-body">
                    ...
                    <div class="d-flex gap-2 rating">
                        @for ($i = 1; $i <= 5; $i++)
                            <label for="star{{ $i }}" class="mb-0 position-relative">
                                ...
                                <input wire:click="setRating({{ $i }})" type="radio"
                                    id="star{{ $i }}" value="{{ $i }}"
                                    class="position-absolute start-0 top-0 w-100 h-100 opacity-0"
                ...
                <div class="d-flex justify-content-center mt-3">
                    <textarea class="form-control @error('review') is-invalid @enderror" placeholder="Tulis ulasan disini..." rows="3"
