            ...
            <div class="col-md-6">
                ...
                <div class="card rounded shadow-sm border-0 mb-4">
                    <div class="card-body">
                        ...
                        <select class="form-select rounded mb-3" wire:model.live="district_id"
                            wire:key="{{ $city_id }}">
                    ...
                    <div class="card rounded shadow-sm border-0 mb-5">
                        <div class="card-body">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="courier" id="courier_sicepat"
                                    wire:click="changeCourier('sicepat')">
                                <label class="form-check-label" for="courier_sicepat">SICEPAT</label>
                            </div>

                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="courier" id="courier_jnt"
                                    wire:click="changeCourier('jnt')">
                                <label class="form-check-label" for="courier_jnt">J&T EXPRESS</label>
                            </div>

                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="courier" id="courier_ninja"
                                    wire:click="changeCourier('ninja')">
                                <label class="form-check-label" for="courier_ninja">NINJA EXPRESS</label>
                            </div>

                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="courier" id="courier_jne"
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="courier" id="courier_tiki"
                                        ...
                                        <div class="form-check form-check-inline">
                                            <label class="form-check-label font-weight-normal me-2">
                                                <input class="form-check-input" type="radio" name="cost"
                                                    wire:click="getServiceAndCost('{{ $cost['cost'] }}|{{ $cost['service'] }}')" />
                                                <span class="ms-1">{{ $cost['service'] }} - Rp
                                                    {{ number_format($cost['cost'], 0, ',', '.') }}</span>
                                            </label>
                                        </div>
                                    @endforeach
                                </div>
